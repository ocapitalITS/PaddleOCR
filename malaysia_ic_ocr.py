...
if uploaded_file is not None:
    ...
    try:
        ...
        noise_words = ['ORPHEUSCAPITAL', 'ONLY', 'SAMPLE', 'SPECIMEN', 'WATERMARK', 'COPYRIGHT', 'AKER', 'ERAJ', 'MALAY', 'SIA', 'PENT', 'GR', 'PENGENJALAN', 'SLAM', 'LALAYSI', 'Touch', 'chip', 'FAETAY', 'ROTI', 'ACAR', 'RA', 'MALAL', 'AKERO']
        ...
        if ic_number:
            ...
            place_name_filters = ['PULAU PINANG', 'SUNGAI DUA', 'GELUGOR', 'SELANGOR', 'JOHOR', 'KEDAH', 
                                  ...
                                  'WILAYAH', 'KLANG', 'PUTRAJAYA', 'LABUAN', 'PENANG', 'PINANG', 'PETALING', 'SHAH ALAM', 'IPOH', 'KOTA BHARU', 'SEPANG']
            ...
            if ic_line_idx is not None:
                ...
                if not name_tokens:
                    ...
                    for i in range(ic_line_idx + 1, len(extracted_text)):
                        ...
                        # Stop if line is clearly a postcode/address number (5+ digits at start)
